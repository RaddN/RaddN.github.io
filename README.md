...
<meta name="google-site-verification" content="Xpl2bqlCKpRa7ZiKFgtoewr0P3f5a314O6C6DtnYSzA" />
  <title>Website & Graphics Designer seo||Raihan Hossain</title>
   <meta name="author" content="Md. Raihan Hossain" />
  <meta name="Description" content="Designer Md. Raihan Hossain. Web Designer, Website Developer, Graphic Designer, SEO expert from Comilla,Bangladesh (BD). I don't say I'm best but I can.You can contact with me call: 01863995432 email: hossainraihan02@gmail.com">
<meta name="Keywords" content="Designer Md. Raihan Hossain Web Designer Website Developer Graphic SEO expert Comilla Bangladesh BD Best 01863995432 hossainraihan02@gmail.com">

 <script data-ad-client="ca-pub-5672298323558810" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
 <!-- Bootstrap CSS File -->
...
<link rel="shortcut icon" href="images/dr_raihan_hossain_logo.png" type="image/x-icon">
<link rel="icon" href="images/dr_raihan_hossain_logo.png" type="image/x-icon">
...
.image-area {
    ...
    #header {
  background: url("../images/Raihan_Hossain.webp") no-repeat center cover;
}
#about .div-img-bg {
    padding-bottom: 30px;
...
<div id="mySidenav" class="sidenav w3-hide-small">
  ...
  <a href="#journal" id="rblog">Skill</a>
      ...
      <div class="row justify-content-between">
		...
		<div class="img-wrapper">
          <div class="div-img-bg">
            <div class="about-img">
                			 <img src="images/me.jpg" class="img-responsive" alt="Designer Raihan Hossain">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="portfolio-container">
            ...
            <div class="col-lg-4 col-md-6 portfolio-thumbnail all Education profiler">
...
<p class="w3-wide"><i class="fa fa-photo"></i>Coreldraw</p>
  <div class="progress">
    <div class="progress-bar progress-bar-striped progress-bar-animated" style="width:80%">80%</div></div>
 ...
 <section class="text-gray-700 body-font relative">
  ...
  <div class="container px-5 py-24 mx-auto flex">
    <div class="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10">
      ...
      <input class="bg-white rounded border text-black border-gray-400 focus:outline-none focus:border-indigo-500 text-base px-4 py-2 mb-4" placeholder="Email" type="email">
